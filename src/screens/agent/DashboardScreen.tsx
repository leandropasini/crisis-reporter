...
const DEMO_OBSERVATIONS: MappedObservation[] = [
  {
    ...
    version_number: 2,
    location_method: "gps",
    modular_fields: { electricity_condition: "destroyed", pressing_needs: ["food_water", "shelter"] },
...
export default function DashboardScreen({
  ...
  if (isMobile) {
    return (
      ...
      >
        {/* Mobile header */}
        <div style={{ flexShrink: 0, paddingTop: "calc(14px + var(--demo-disclaimer-h, 0px))", paddingRight: 20, paddingBottom: 14, paddingLeft: 20, borderBottom: "1px solid var(--cr-border)", position: "relative", zIndex: 1001 }}>
