...
export default function DetailsScreen({ modularFieldsEnabled = false, initialName, onConfirm, onBack, modeLabel, totalSteps = 6 }: Props) {
  ...
  const ELECTRICITY_OPTIONS: { value: ElectricityCondition; label: string }[] = [
    ...
    { value: "destroyed",       label: t("details.elec_no_service")      },
  ...
  const HEALTH_OPTIONS: { value: HealthServices; label: string }[] = [
    ...
    { value: "largely_disrupted",    label: t("details.health_not_functional")       },
    { value: "not_functioning",      label: t("details.health_not_functional")       },
    { value: "unknown",              label: t("details.health_unknown")              },
  ];

  const NEEDS_OPTIONS: { value: PressingNeed; label: string }[] = [
    { value: "food_water",     label: t("details.need_food")          },
    { value: "cash",           label: t("details.need_water")         },
    { value: "healthcare",     label: t("details.need_medical_care")  },
    { value: "shelter",        label: t("details.need_shelter")       },
    { value: "livelihoods",    label: t("details.need_electricity")   },
    { value: "wash",           label: t("details.need_sanitation")    },
    { value: "basic_services", label: t("details.need_communication") },
    { value: "protection",     label: t("details.need_transport")     },
    { value: "local_support",  label: t("details.need_transport")     },
