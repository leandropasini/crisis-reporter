...
INSERT INTO observations (id,crisis_id,infrastructure_name,infrastructure_type,damage_level,debris_clearing_needed,photo_url,latitude,longitude,location_method,source,session_id,language,confidence,version_number,status,client_created_at,modular_fields)
VALUES ('d0000000-0000-0000-0000-000000000002',cid,'Residência — Rua dos Andradas 550','residential','complete',FALSE,'https://picsum.photos/seed/r02/800/600',-30.0310,-51.2210,'gps','citizen',sess,'pt',73,1,'active',NOW() - INTERVAL '4 hours','{"electricity_condition":"no_service","pressing_needs":["shelter","water"]}'::jsonb) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO observations (id,crisis_id,infrastructure_name,infrastructure_type,damage_level,debris_clearing_needed,photo_url,latitude,longitude,location_method,source,session_id,language,confidence,version_number,status,client_created_at,modular_fields)
VALUES ('d0000000-0000-0000-0000-000000000004',cid,'EMEF Escola Municipal Irmão Pedro','school','complete',TRUE,'https://picsum.photos/seed/r04/800/600',-30.0180,-51.1980,'gps','drone',sess,'pt',85,2,'active',NOW() - INTERVAL '8 hours','{"electricity_condition":"no_service","pressing_needs":["shelter","food"]}'::jsonb) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO observations (id,crisis_id,infrastructure_name,infrastructure_type,damage_level,debris_clearing_needed,photo_url,latitude,longitude,location_method,source,session_id,language,confidence,version_number,status,client_created_at,modular_fields)
VALUES ('d0000000-0000-0000-0000-000000000006',cid,'Subestação CEEE — Navegantes','utility','complete',FALSE,'https://picsum.photos/seed/r06/800/600',-30.0350,-51.2290,'gps','sensor',sess,'pt',92,1,'active',NOW() - INTERVAL '16 hours','{"electricity_condition":"no_service","pressing_needs":["electricity","water"]}'::jsonb) ON CONFLICT (id) DO NOTHING;
